...
class Login extends Component {
    ...
    updateAccount = async (e) => {
        ...
        const api_call = await fetch('katie4113.uksouth.cloudapp.azure.com:8080/QuizAPI/api/account/updateAccount/' + requestbody.email, {
            method: 'PUT',
    ...
    deleteAccount = async (e) => {
        ...
        const api_call = await fetch('katie4113.uksouth.cloudapp.azure.com:8080/QuizAPI/api/account/deleteAccount/' + requestbody, {
            method: 'DELETE',
        });
        try {
            const response = await api_call.json();
    ...
    createAccount = async (e) => {
        ...
        const api_call = await fetch('katie4113.uksouth.cloudapp.azure.com:8080/QuizAPI/api/account/createAccount', {
            method: 'POST',
            body: JSON.stringify(requestbody)
        });
        try {
    ...
    verifyAccount = async (e) => {
        ...
        const api_call = await fetch('katie4113.uksouth.cloudapp.azure.com:8080/QuizAPI/api/account/verifyAccount', {
            method: 'POST',
            body: JSON.stringify(requestbody)
