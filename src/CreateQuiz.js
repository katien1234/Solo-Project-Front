...
class CreateQuiz extends Component {
    ...
    deleteQuiz = async (e) => {
        ...
        const api_call = await fetch('http://katie4113.uksouth.cloudapp.azure.com:8181/QuizAPI/api/quiz/deleteQuiz/' + requestbody, {
            method: 'DELETE',
        });
    ...
    createQuiz = async (e) => {
        ...
        const api_call = await fetch('http://katie4113.uksouth.cloudapp.azure.com:8181/QuizAPI/api/quiz/createQuiz', {
            method: 'POST',
    ...
    updateQuiz = async (e) => {
        ...
        const api_call = await fetch('http://katie4113.uksouth.cloudapp.azure.com:8181/QuizAPI/api/quiz/updateQuiz/' + requestbody.question, {
            method: 'PUT',
            body: JSON.stringify(requestbody)
