...
class CreateQuiz extends Component {
    ...
    deleteQuiz = async (e) => {
        ...
        const api_call = await fetch('katie4113.uksouth.cloudapp.azure.com:8080/QuizAPI/api/quiz/deleteQuiz/' + requestbody, {
            method: 'DELETE',
        });
    ...
    createQuiz = async (e) => {
        ...
        const api_call = await fetch('katie4113.uksouth.cloudapp.azure.com:8080/QuizAPI/api/quiz/createQuiz', {
            method: 'POST',
    ...
    updateQuiz = async (e) => {
        ...
        const api_call = await fetch('katie4113.uksouth.cloudapp.azure.com:8080/QuizAPI/api/quiz/updateQuiz/' + requestbody.question, {
            method: 'PUT',
            body: JSON.stringify(requestbody)
    ...
    getQuiz = async (e) => {
        e.preventDefault();
        try {
            const api_call = await fetch('katie4113.uksouth.cloudapp.azure.com:8080/QuizAPI/api/quiz/getQuiz');
            const response = await api_call.json();
            const tempQuizList = []
            var i = 0
    ...
    getQuizByCat = async (e) => {
        e.preventDefault();
        try{
        const api_call = await fetch('katie4113.uksouth.cloudapp.azure.com:8080/QuizAPI/api/quiz/getQuizByCat/' + e.target.elements.category.value);
        const response = await api_call.json();
        const tempQuizList = []
        var i = 0
        for (let i = 0; i < response.length; i++) {
